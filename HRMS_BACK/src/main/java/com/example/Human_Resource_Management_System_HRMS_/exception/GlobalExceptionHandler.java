...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<BasicRes> handleApplicationException(ApplicationException ex) {
		return new ResponseEntity<>(
			new BasicRes(ex.getCode(), ex.getMessage()),
			HttpStatus.valueOf(ex.getCode()) // 例如 409 就會自動套用
		);
	}
